...
edg = 'edge_{0}_{1}'.format(edges[idx][0], edges[idx][1])
fe.atom_mapping(edge=edg, bVerbose=False)
...
#fe.JOBsimcpu = 4
#fe.JOBqueue = 'SGE'
#fe.JOBsource = ['/etc/profile.d/modules.sh','/usr/local/gromacs/GMXRC2022']
#fe.JOBmodules = ['shared','owl/intel-mpi-default','cuda91']
#fe.JOBbGPU = True
#fe.JOBgmx = 'gmx_threads_AVX_256 mdrun'
#fe.JOBpartition= ''#'p08,p10,p16,p20,p24,p06,p32,p00' #'short'
